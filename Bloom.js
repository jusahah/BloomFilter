...
This package implements simple Bloom Filtering functionality. The hash functions used here are very elementary. If you decide to use
this package in production environment, do plug in your own hashing functions!

Package has no external depencies.

I tried to keep everything modular. The Bloom Filter consists four Javascript functions:
...
First one is simply an interface which contains BloomData and BloomFunction.

Second one is representation of internal data structure (array of 0s and 1s) and methods for accessing/modifying it.

Third one is the Bloom Function which is used solely for hashing a given string.

Fourth one provided testing interface, including simple graph tool. This takes two args in constructor: 1) Bloom object 2) DOM-element for graph. 
